...
{% block content %}
	<section id="basic-datatable">
		<div class="row">
			<div class="col-12">
				<div class="card">
					<table class="datatables-basic table table-bordered" data-addlink="{{base_url('sys/users/new')}}" data-label="USERS LIST">
						<thead>
							<tr>
								<th></th>
								<th>Username</th>
									...
									<td class="text-center">
										<div class="d-inline-flex">
											...
											<div class="dropdown-menu dropdown-menu-end">
												<a href="{{base_url('sys/users/detail/' ~ item.id )}}" class="dropdown-item">
												...
												<a href="{{base_url('sys/users/delete/' ~ item.id )}}" class="dropdown-item delete-record">
										...
										<a href="{{base_url('sys/users/edit/' ~ item.id )}}" class="item-edit">
