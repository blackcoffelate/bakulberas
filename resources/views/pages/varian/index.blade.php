...
@section('content')
	<section id="basic-datatable">
		<div class="row">
			<div class="col-md-8">
				<div class="card">
					<table class="datatables-basic table table-bordered" data-addlink="{{ route('varianNew')}}" data-label="VARIAN LIST">
						<thead>
							<tr>
								<th>Varian</th>
								<th>Info</th>
									...
									<td class="text-center">
										<div class="d-inline-flex">
											...
											<div class="dropdown-menu dropdown-menu-end">
												<a href="{{ route('varianDetail', $list['id'])}}" class="dropdown-item">
												...
												<a href="{{ route('varianDelete', $list['id'])}}" class="dropdown-item delete-record">
										...
										<a href="{{ route('varianEdit', $list['id'])}}" class="item-edit">
