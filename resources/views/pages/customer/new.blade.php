		...
		<div class="row">
			<div class="col-md-6 col-12">
				<div class="card">
					...
					<div class="card-body">
						<form class="form form-horizontal" method="post" enctype="multipart/form-data" action="{{ route('customerInsert')}}">
							@csrf
							<div class="row">
								<div class="col-12">
									<div class="mb-1 row">
										...
										<div class="col-sm-9">
											<input type="text" autocomplete="off" id="kode" class="form-control" name="o[kode]" required="true" value="CUS-{{$kode}}" readonly="true" />
										</div>
									</div>
								</div>
								<div class="col-12">
