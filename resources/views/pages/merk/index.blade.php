...
@section('content')
	<section id="basic-datatable">
		<div class="row">
			<div class="col-md-8">
				<div class="card">
					<table class="datatables-basic table table-bordered" data-addlink="{{	route('merkNew')}}" data-label="MERK LIST">
						<thead>
							<tr>
								<th>Merk</th>
								<th>Info</th>
									...
									<td class="text-center">
										<div class="d-inline-flex">
											...
											<div class="dropdown-menu dropdown-menu-end">
												<a href="{{ route('merkDetail', $list['id'])}}" class="dropdown-item">
												...
												<a href="{{ route('merkDelete', $list['id'])}}" class="dropdown-item delete-record">
										...
										<a href="{{ route('merkEdit', $list['id'])}}" class="item-edit">
