...
@section('content')
	<section id="basic-datatable">
		<div class="row">
			<div class="col-12">
				<div class="card">
					<table class="datatables-basic table table-bordered" data-addlink="{{ route('soNew')}}" data-label="PENGELUARAN PEMBELIAN (SO)">
						<thead>
							<tr>
								<th>Kode</th>
								<th>Tanggal</th>
									...
									<td class="text-center">
										<div class="d-inline-flex">
											...
											<div class="dropdown-menu dropdown-menu-end">
												<a href="{{ route('soDetail', $list->id)}}" class="dropdown-item">
												...
												<a href="{{ route('soDelete', $list->id)}}" class="dropdown-item delete-record">
										...
										<a href="{{ route('soEdit', $list->id)}}" class="item-edit">
