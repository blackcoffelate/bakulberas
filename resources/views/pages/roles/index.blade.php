...
@section('content')
	<section id="basic-datatable">
		<div class="row">
			<div class="col-12">
				<div class="card">
					<table class="datatables-basic table table-bordered" data-addlink="{{ route('rolesNew')}}" data-label="ROLE LIST">
						<thead>
							<tr>
								<th>Role</th>
								<th>Info</th>
									...
									<td class="text-center">
										<div class="d-inline-flex">
											...
											<div class="dropdown-menu dropdown-menu-end">
												<a href="{{ route('rolesDetail', $list['id'])}}" class="dropdown-item">
												...
												<a href="{{ route('rolesDelete', $list['id'])}}" class="dropdown-item delete-record">
										...
										<a href="{{route('rolesEdit', $list['id'])}}" class="item-edit">
