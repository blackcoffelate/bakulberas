...
@section('content')
	<section id="basic-datatable">
		<div class="row">
			<div class="col-md-8">
				<div class="card">
					<table class="datatables-basic table table-bordered" data-addlink="{{ route('satuanNew')}}" data-label="SATUAN LIST">
						<thead>
							<tr>
								<th>Satuan</th>
								<th>Info</th>
									...
									<td class="text-center">
										<div class="d-inline-flex">
											...
											<div class="dropdown-menu dropdown-menu-end">
												<a href="{{ route('satuanDetail', $item['id'])}}" class="dropdown-item">
												...
												<a href="{{ route('satuanDelete', $item['id'])}}" class="dropdown-item delete-record">
										...
										<a href="{{ route('satuanEdit', $item['id'])}}" class="item-edit">
